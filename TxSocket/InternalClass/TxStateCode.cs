namespace SuperNetwork.TxSocket.PasswordManage
{
    ...
    internal class TxStateCode
    {
        ...
        internal TxStateCode(byte i, string str)
        {
            _state = i;
            _datestring = str;
        }
        ...
        internal TxStateCode(byte i, string str,byte[] replyDate)
        {
            _state = i;
            _datestring = str;
        ...
        internal TxStateCode(byte i, byte[] dateByte, byte[] replyDate)
        {
            _state = i;
            _dateByte = dateByte;
            _replyDate = replyDate;
        ...
        internal TxStateCode(byte i,byte[] b)
        {
            _state = i;
            _dateByte = b;
        }
        ...
        internal TxStateCode(byte[] replyDate)
        {
            _replyDate = replyDate;
        }
        /// <summary>
        ...
        internal TxStateCode(int Label, byte[] dateByte)
        {
        ...
        internal TxStateCode(byte state,int Label)
        {
            _state = state;
            _sendDateLabel = Label;
        }
