    ...
    public class FTxBase : ITxBase
    {
       ...
       /// </summary>
        ...
        internal void SendMessage(StateBase stateOne, byte[] data)
        {
            if (stateOne == null)
                return;
            TxStateCode stateCode = new TxStateCode(PasswordCode._photographCode, data);
        ...
        internal void SendMessage(StateBase stateOne, string data)
        {
            if (stateOne == null)
                return;
            TxStateCode stateCode = new TxStateCode(PasswordCode._textCode, data);
            byte[] sendDate = EncryptionDecrypt.encryption(stateCode, stateOne);
            stateOne.SendDate = sendDate;
            Send(stateOne, sendDate);
        }
        ...
        internal void CodeManage(StateBase stateOne, TxStateCode statecode)
        {
        ...
        internal void CommonCodeManage(StateBase stateOne, TxStateCode stateCode)
        {
