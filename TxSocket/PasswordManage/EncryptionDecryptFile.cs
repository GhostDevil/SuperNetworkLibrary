...
namespace SuperNetwork.TxSocket.PasswordManage
{
    internal class EncryptionDecryptFile
    {
       ...
       internal static byte[] FileHeadEncryption(FileState fileSend)
       {
           ...
           ByteToData.IntToByte(fileSend.FileLabel, 3, haveDate);
           ByteToData.IntToByte(fileSend.FileLenth, 7, haveDate);
       ...
       {
           int lable = ByteToData.ByteToInt(3, fileDate);
           long fileLenth = ByteToData.ByteToLong(7, fileDate);
       ...
       internal static byte[] FileSubjectEncryption(FileState fileSend,int bufferSize)
       {
           ...
           dateOverall = ByteToData.OffsetEncryption(haveDate, fileSend.FileLabel, 3);
       ...
       { 
           ...
           haveDate[1] = whoDate;
           haveDate[2] = code;
           ByteToData.IntToByte(fileLabel, 3, haveDate);
           return haveDate;
       }
       /// <summary>
       ...
       internal static byte[] ReceiveContingueEncryption(byte code, FileState fileState)
       {
           ...
           haveDate[2] = code;
           ByteToData.IntToByte(fileState.FileLabel, 3, haveDate);
           ByteToData.IntToByte(fileState.FileOkLenth, 7, haveDate);
           return haveDate;
       }
    }
}
