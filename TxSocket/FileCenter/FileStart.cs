...
namespace SuperNetwork.TxSocket.FileCenter
{
    /// <summary>
    ...
    public class FileStart
    {
       ...
       internal static byte[] ReceiveDateTO(byte[] fileDate, StateBase stateOne)
       {
           ...
           if (code == PasswordCode._receiveUser)
           {
               ...
               { haveDate = EncryptionDecryptFile.FileSevenEncryption(PasswordCode._sendUser, PasswordCode._fileCancel, ByteToData.ByteToInt(3, fileDate)); }
           ...
           else if (code == PasswordCode._sendUser)
           {
               ...
               { haveDate = EncryptionDecryptFile.FileSevenEncryption(PasswordCode._receiveUser, PasswordCode._fileCancel, ByteToData.ByteToInt(3, fileDate)); }
