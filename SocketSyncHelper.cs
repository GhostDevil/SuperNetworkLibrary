...
namespace SuperNetwork
{
    ...
    public class SocketSyncHelper
    {
        ...
        public static bool IsTrueIP(string source)
        {
        ...
        {
            //将字符串消息转换成字符数组
            byte[] buffer = StringToBytes(msg, Encoding.Default);
        ...
        public static string ReceiveMsg(Socket socket)
        {
            ...
            //转换成字符串，并将其返回
            return BytesToString(tempBuffer, Encoding.Default);
        }
        #endregion
        ...
        private static byte[] StringToBytes(string text, Encoding encoding)
        {
